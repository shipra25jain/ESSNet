...
class Visualizer(object):
    """ Visualizer
    """
    def __init__(self, port='13579', env='main', id=None,log_to_filename=None):
        self.cur_win = {}
        self.vis = Visdom(port=port,server='shijain@knurrhahn.ee.ethz.ch', env=env,log_to_filename=log_to_filename)
        self.id = id
        self.env = env
        # Restore
